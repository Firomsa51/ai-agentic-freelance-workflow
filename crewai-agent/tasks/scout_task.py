...
def build_scout_task(agent, keywords: str = "AI automation freelance Python") -> Task:
    return Task(
        description=(
            ...
            "Requirements:\n"
            "1. Use the freelance_job_search tool to find at least 5 relevant jobs.\n"
            ...
            "5. Return the results as a clean JSON array."
        ),
        expected_output=(
            "A JSON array of job objects, each containing: title, company, description, "
            "url, source, salary, type. Minimum 5 jobs, maximum 15."
        ),
        agent=agent,
    )
